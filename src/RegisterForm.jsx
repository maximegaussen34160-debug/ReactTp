...
function RegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const saltRes = await fetch("http://localhost:8080/salt");
      ...
      const response = await fetch("http://localhost:8080/user", {
        ...
        body: JSON.stringify({ email, pass: hashedPassword, salt }),
      });
  ...
  return (
    <div className="apple-page">
      <div className="apple-card">
        ...
        <h1 className="apple-title">Créer votre identifiant</h1>
        ...
        {isSuccess ? (
          ...
          <>
            ...
            <a className="apple-link" href="/login">
